  ...
  return (
    <section className="flex flex-col">
      <div className="h-screen grid grid-cols-12">
        <div className="col-span-5 bg-violet-600 h-full flex justify-end items-center">
          <img
            src={"Images/Kaustubh.jpg"}
            className="kaustubh-img border lg:translate-x-1/4"
          />
        </div>
        <div className="col-span-7 flex items-center justify-center text-neutral-800">
          <div className="flex flex-col">
            ...
            <p
              className={`${raleway.className} text-2xl`}
